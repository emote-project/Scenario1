...
public class TurnTakingManager {
    ...
    private Integer timeOut, utteranceTimerTimeOut;
    ...
    public void processInputAndPerform (JSONObject systemInput) throws JSONException {
    	...
    	if (interactionStatus){
	        ...
	        if (nextUtterance != null) {
	            ...
	            scheduleTimeout (utteranceTimerTimeOut , "utteranceTimer");
	        } else {
	        	if (interactionStatus){
	        		if (!utterancePlaying){
        ...
        synchronized (timer) {
            ...
            if (timeout >= 0 && reason.equalsIgnoreCase("waitForUserResponse")) {
                tt = new TimerTask () {
                    ...
                    public void run () {
                        tt = null;
                        logger.info ("Waitforuserresponse Timeout expired!");
                        sendTimeout ();
                    }
                };
                ...
                tt = new TimerTask () {
                    ...
                    public void run () {
                        tt = null;
                        logger.info ("Utterance timeout expired!");
