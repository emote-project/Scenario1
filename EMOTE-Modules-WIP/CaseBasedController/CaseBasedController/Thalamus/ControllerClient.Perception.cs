...
namespace CaseBasedController.Thalamus
{
    public partial class ControllerClient : IAllPerceptionClient
    {
            ...
            string gazeDirection)
        {
            if (this.OKAOPerceptionEvent != null)
                this.OKAOPerceptionEvent(this,
                    ...
                    {
                        PerceptionLog = new PerceptionLog(
                            ...
                            sadness, surprise, neutral, gazeVectorX, gazeVectorY, gazeDirection)
                    });
        }
        ...
        {
            var eventArgs = new LearnerModelMemoryEventArgs
            {
                MemoryEvent = MemoryEvent.DeserializeFromJson(MemoryEvent_memoryEvent)
            };
        ...
        public void Start(string StartMessageInfo_info)
        {
            ...
            GameInfo.GameStatus.Session = startMessageInfo.SessionId;
            if (StartEvent != null) 
                StartEvent(this, new StartEventArgs(){ StartMessageInfo = startMessageInfo});
        }
