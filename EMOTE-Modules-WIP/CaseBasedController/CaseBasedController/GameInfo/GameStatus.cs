...
namespace CaseBasedController.GameInfo
{
    ...
    public static class GameStatus
    {
        ...
        {
            Economy,Environment,Population,Money,Oil,Power,Wellbeing,None
        }
        public static AiActionStrategy GetMainStrategy()
        {
            var strategy = GameStatus.CurrentState.StrategiesUsedForLastBestAction;
        ...
        public static void perceptionClient_GameStartedEvent(object sender, GenericGameEventArgs e)
        {
            ...
            {
                var gameInfo = EmoteEvents.EnercitiesGameInfo.DeserializeFromJson(e.SerializedGameState);
        ...
        {
            CurrentState.StrategiesUsedForLastBestAction = Strategy.DeserializeFromJson(iaEventArgs.Strategy_planStrategy);
        }
