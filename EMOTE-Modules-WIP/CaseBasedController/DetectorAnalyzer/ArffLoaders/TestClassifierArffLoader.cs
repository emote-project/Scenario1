...
namespace DetectorAnalyzer.ArffLoaders
{
    public class TestClassifierArffLoader : ClassificationArffLoader
    {
        ...
        public ClassificationPerformance Performance { get; private set; }
        ...
        protected override void Reset()
        {
            ...
            this.Performance = new ClassificationPerformance((uint) numLabels, (TreeClassifier) classifier, counts);
