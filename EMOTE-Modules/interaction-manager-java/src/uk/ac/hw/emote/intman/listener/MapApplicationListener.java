        ...
        */
        ...
        try {
            ...
            for (int i=0; i < competencyName.size();i++){
            	...
            	overallSkillLevel += competencySkillLevel.getDouble(i);
        	}
            overallSkillLevel = overallSkillLevel / competencyName.size();
            if (overallSkillLevel < 0.33){
    			systemInput.put("overallSkillLevel", "low");
    		} else if (overallSkillLevel < 0.66){
    			systemInput.put("overallSkillLevel", "medium");
    		} else {
    			systemInput.put("overallSkillLevel", "high");
    		}
