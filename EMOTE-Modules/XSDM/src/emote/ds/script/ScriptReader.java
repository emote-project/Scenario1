...
import emote.ds.im.Action;
import emote.ds.im.ActionAnd;
import emote.ds.im.ActionOr;
import emote.ds.im.DialogueManager;
import emote.ds.im.Rule;
import emote.ds.im.Rules;
import emote.ds.im.Strategy;
...
public class ScriptReader {
	...
	private void getDialogueSpecification(Document scriptDoc) throws DocumentException, JSONException {
		Element root = scriptDoc.getRootElement();
		Boolean dialogueStateFound, inputFound, outputFound, stateUpdateRulesFound, actionSelectionRulesFound, metricFound;
		dialogueStateFound = inputFound = outputFound = stateUpdateRulesFound = actionSelectionRulesFound = metricFound = false;
